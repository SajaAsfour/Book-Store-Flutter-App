...
import 'package:book_store/features/forget_password/data/repo/forget_password_repo.dart';
  ...
  void forgetPassword({
    ...
    if (response is Response) {
      if (response.statusCode == 200) {
        ...
        emit(ForgetPasswordError('A server error occurred, please try again later.'));
      }
    } else {
      emit(ForgetPasswordError('An unexpected error occurred, please try again later.'));
    }
  }
}
