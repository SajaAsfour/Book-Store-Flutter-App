...
import 'package:book_store/features/reset_password/data/repo/reset_password_repo.dart';
  ...
  void resetPassword({
    ...
    if (response is Response) {
      if (response.statusCode == 200) {
        ...
        emit(ResetPasswordError('A server error occurred, please try again later.'));
      }
    } else {
      emit(ResetPasswordError('An unexpected error occurred, please try again later.'));
    }
  }
}
